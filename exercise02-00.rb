...
puts "You have #{list_items} items"
...
#4.
puts "The second item you need is #{grocery_list[1]}"

# 5. .sort will automatically sort by default by A-Z
sorted_list = grocery_list.sort
output_list(sorted_list)

#6 use delete in this case
